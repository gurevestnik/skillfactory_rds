 ...
 "cells": [
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "['.ipynb_checkpoints', 'cinema.csv', 'module1.ipynb', 'глава 1', 'глава 2', 'Дима.ipynb']\n"
     ]
    }
   ],
   "source": [
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "50  tt2140379    2.578919   26000000    30523226   \n",
       "51  tt3045616    2.575711   60000000    30418560   \n",
       "52  tt0810819    2.557859   15000000    64191523   \n",
       "53  tt2717822    2.550747   70000000    17752940   \n",
       "54  tt3397884    2.487849   30000000    84025816   \n",
       "55  tt1502712    2.487042  120000001   167977596   \n",
       "56  tt3079380    2.404473   65000000   235666219   \n",
       "57  tt2381941    2.395366   50100000   153962963   \n",
       "58  tt2679042    2.354654   35000000    82347656   \n",
       "59  tt1390411    2.345821  100000000    93820758   \n",
       "\n",
       "                           original_title  \\\n",
       "0                          Jurassic World   \n",
       "1                      Mad Max: Fury Road   \n",
       ...
       "50  Ryan Reynolds|Ben Kingsley|Natalie Martinez|Ma...   \n",
       "51  Johnny Depp|Gwyneth Paltrow|Ewan McGregor|Paul...   \n",
       "52  Eddie Redmayne|Alicia Vikander|Matthias Schoen...   \n",
       "53  Chris Hemsworth|Leehom Wang|Tang Wei|Viola Dav...   \n",
       "54  Emily Blunt|Benicio del Toro|Josh Brolin|Victo...   \n",
       "55  Miles Teller|Kate Mara|Michael B. Jordan|Jamie...   \n",
       "56  Melissa McCarthy|Jason Statham|Rose Byrne|Mira...   \n",
  ...
  },
  {
   ...
   "source": [
    ...
    "data[data.margin == data.margin.max()].original_title"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "data['margin'] = data.revenue - data.budget\n",
    "data[data.margin == data.margin.min()].original_title"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    ...
    "c = collections.Counter()\n",
    "\n",
    "for direct in data.director:\n",
    "    for dd in direct.split('|'):\n",
    "        c[dd] += 1\n",
    "print(c)\n"
   ]
  },
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Counter({'Peter Jackson': 5202593685, 'David Yates': 3379295625, 'Christopher Nolan': 3162548502, 'J.J. Abrams': 2839169916, 'Michael Bay': 2760938960, 'James Cameron': 2548546718, 'Francis Lawrence': 2476979588, 'Pierre Coffin': 2452006832, 'Steven Spielberg': 2449700791, 'Joss Whedon': 2424593677, 'Gore Verbinski': 2271362290, 'Sam Raimi': 2254066354, 'Lee Unkrich': 2081614145, 'Ridley Scott': 2044035909, 'Andrew Adamson': 1957706346, 'Chris Columbus': 1906968952, 'Carlos Saldanha': 1882719105, 'Tim Burton': 1801663457, 'Eric Darnell': 1755054393, 'Sam Mendes': 1710352791, 'Tom McGrath': 1705388064, 'Pete Docter': 1682867609, 'Chris Renaud': 1648116186, 'James Wan': 1620441367, 'Brad Bird': 1581913958, 'Conrad Vernon': 1578269902, 'Shawn Levy': 1515787063, 'Justin Lin': 1472947074, 'Steven Soderbergh': 1450928588, 'Ron Howard': 1379257991, 'Bill Condon': 1376664544, 'Colin Trevorrow': 1363528810, 'Kyle Balda': 1361571278, 'Clint Eastwood': 1329766334, 'Roland Emmerich': 1310587076, 'Todd Phillips': 1279393447, 'George Lucas': 1266398328, 'Alfonso CuarÃ³n': 1265157010, 'Chris Buck': 1188263522, 'Raja Gosnell': 1188104000, 'M. Night Shyamalan': 1152548638, 'Rob Marshall': 1143605066, 'Steve Martino': 1141615909, 'Andrew Stanton': 1136076938, 'Jennifer Lee': 1124219009, 'Marc Webb': 1096156023, 'Chris Miller': 1063945642, 'Jon Favreau': 1057296331, 'Quentin Tarantino': 1036139583, 'Shane Black': 1015439994, 'Zack Snyder': 992937193, 'David Fincher': 987983520, 'Kelly Asbury': 966114729, 'Jay Roach': 956344409, 'Chris Weitz': 954062326, 'Mike Mitchell': 906666117, 'David Silverman': 899885107, 'Nancy Meyers': 893677472, 'Mike Newell': 890683287, 'Lana Wachowski': 874004266, 'Lilly Wachowski': 874004266, 'Dean DeBlois': 859773334, 'Doug Liman': 854203108, 'Phil Lord': 850176100, 'Christopher Miller': 850176100, 'Chris Sanders': 845829214, 'Brett Ratner': 843419041, 'Tom Hooper': 829212842, 'Marc Forster': 817521590, 'Robert Zemeckis': 813123904, 'Bryan Singer': 811212100, 'Martin Scorsese': 802194907, 'Mike Thurmeier': 782244782, 'Dennis Dugan': 774026753, 'Ang Lee': 761420806, 'Guy Ritchie': 758085675, 'Jon Turteltaub': 751201254, 'Peyton Reed': 745340963, 'Kenneth Branagh': 732015467, 'Peter Berg': 721181428, 'Rob Letterman': 716338428, 'Olivier Megaton': 708858133, 'Vicky Jenson': 708089482, 'Barry Sonnenfeld': 706867642, 'John Lasseter': 701835545, 'Christopher McQuarrie': 690670734, 'Matt Reeves': 688109639, 'Paul Greengrass': 682493340, 'Chris Wedge': 678380764, 'Tim Story': 678087416, 'Gary Ross': 677547137, 'David Slade': 675997320, 'James Mangold': 674085743, 'Martin Campbell': 671862395, 'Brad Peyton': 664667356, 'Mel Gibson': 662074710, 'Phyllida Lloyd': 659798336, 'Genndy Tartakovsky': 659559147, 'Paul W.S. Anderson': 655874490, 'Seth MacFarlane': 647231921, 'Chris Williams': 647085437, 'Matthew Vaughn': 640971176, 'Raman Hui': 638958165, 'Jonathan Liebesman': 635666756, 'Alejandro GonzÃ¡lez IÃ±Ã¡rritu': 633923618, 'James Gunn': 629751387, 'Joe Russo': 621197940, 'Anthony Russo': 621197940, 'Joel Coen': 616968145, 'Stephen Sommers': 602739766, 'Alan Taylor': 595368537, 'Andy Tennant': 585953885, 'Rob Cohen': 580154301, 'Robert Stromberg': 578410378, 'Darren Aronofsky': 571450089, 'Wes Ball': 564576787, 'Bob Peterson': 556342744, 'Wolfgang Petersen': 549841306, 'Danny Boyle': 548659594, 'Peter Segal': 545449931, 'Dan Scanlon': 543559607, 'Paul Feig': 542223922, 'Michael Patrick King': 538600478, '
': 257553595, 'Baltasar KormÃ¡kur': 257467995, 'Sharon Maguire': 256929795, 'Lee Tamahori': 256062835, 'David R. Ellis': 253164703, 'Will Gluck': 251257886, 'John R. Leonetti': 248773813, 'Brian A Miller': 248586800, 'Louis Leterrier': 246091791, 'Michael Mann': 244130185, 'Sean Anders': 243064116, 'Wes Anderson': 238584160, 'Peter Lord': 238172925, 'Paul Tibbitt': 237594032, 'Mikael HÃ¥fstrÃ¶m': 237121418, 'Mark Dindal': 233760352, 'Woody Allen': 231220507, 'Noam Murro': 231150015, 'Jimmy Hayward': 230677014, 'Ben Stiller': 226986952, 'Ralph Zondag': 226748063, 'Eric Leighton': 226748063, 'Rupert Sanders': 226600000, 'Timur Bekmambetov': 226535147, 'Phillip Noyce': 225309529, 'Gavin Hood': 223765839, 'Steven Quale': 221489837, 'Mark Steven Johnson': 219918111, 'Morten Tyldum': 219555708, 'Jon Hurwitz': 216482707, 'Hayden Schlossberg': 216482707, 'Greg Mottola': 215077082, 'Stephen Frears': 213640295, 'David Ayer': 213022677, 'Luke Greenfield': 212707109, 'Dominic Sena': 212588740, 'Jesse Dylan': 206675071, 'Scott Waugh': 206550402, 'Steve Bendelack': 204736344, 'Paul King': 204207227, 'Stephen Daldry': 204093953, 'Jason Friedberg': 199717971, 'Aaron Seltzer': 199717971, 'George Clooney': 199090901, 'Steven Brill': 198339641, 'Ken Kwapis': 198330028, 'Tony Gilroy': 196418121, 'Glenn Ficarra': 194366195, 'John Requa': 194366195, 'Takashi Shimizu': 192618441, 'Richard Curtis': 191280550, 'Wes Craven': 189989623, 'Joel Schumacher': 186642604, 'Oliver Stone': 183398571, 'Thor Freudenthal': 183313709, 'John Hamburg': 180600372, 'Florian Henckel von Donnersmarck': 178346189, 'Eric Brevig': 178286201, 'Josh Trank': 177977595, 'Cameron Crowe': 177138780, 'Joe Wright': 176304564, 'Tommy Wirkola': 174803475, 'Curtis Hanson': 174000000, 'Kevin Greutert': 173384063, 'Jason Moore': 173361479, 'Cody Cameron': 170384621, 'Kris Pearn': 170384621, 'Pierre Morel': 170079448, 'Klay Hall': 169788712, 'Steve McQueen': 167000000, 'Marc Lawrence': 166531590, 'Michael Sucsy': 166114570, 'Michael Lembeck': 163658589, 'Steve Box': 162452832, 'Alejandro AmenÃ¡bar': 161988542, 'Peter Ramsey': 161941670, 'Anthony Stacchi': 160564797, 'Michel Gondry': 160075374, 'Joe Carnahan': 159621022, 'Boaz Yakin': 158115781, 'Peter Sohn': 156926147, 'Randall Wallace': 154245117, 'Alexandre Aja': 151248317, 'James Bobin': 150567350, 'John Whitesell': 149874476, 'Stefen Fangmeier': 149288105, 'Rawson Marshall Thurber': 147722310, 'David Soren': 147570682, 'Richard LaGravenese': 147006123, 'Gary Shore': 145529201, 'Ryan Murphy': 144594016, 'Lee Daniels': 144570008, 'Gary Winick': 144119158, 'Hoyt Yeatman': 142817841, 'Ivan Reitman': 141156732, 'Jonathan Levine': 140564441, '
cÃ\\xada': -2365172, 'Dean Wright': -2377154, 'Chris Sivertson': -2379601, 'Dan Rush': -2385227, 'Danny Cannon': -2389127, 'Noah Baumbach': -2412515, 'Robert Iscove': -2450462, 'Oxide Pang Chun': -2512610, 'Danny Pang': -2512610, 'Rob Thomas': -2514873, 'James Cox': -2533556, 'Michael Cuesta': -2549154, 'Don Scardino': -2562119, 'Chris Koch': -2567837, 'Thomas Bezucha': -2575000, 'Josh Schwartz': -2582638, 'Adam Wingard': -2632839, 'Ernest R. Dickerson': -2683342, 'Tommy Lee Jones': -2963851, 'Derrick Borte': -2977272, 'Kevin Reynolds': -3000000, 'Asif Kapadia': -3007986, 'Julie Anne Robinson': -3106279, 'Gregory Hoblit': -3123301, 'Mabrouk El Mechri': -3136417, 'Rob Bowman': -3256452, 'Peter Bogdanovich': -3353006, 'Paul Abascal': -3394237, 'Benson Lee': -3450523, 'Alex Kurtzman': -3565222, \"Tommy O'Haver\": -3611233, 'John Herzfeld': -3640020, 'Jorma Taccone': -3890000, 'David Mackenzie': -3900000, 'Diane Keaton': -3962091, 'Jane Campion': -4059945, 'Zal Batmanglij': -4098490, 'Jeff Schaffer': -4203153, 'Liev Schreiber': -4302070, 'Stuart Beattie': -4340472, 'Michael J. Bassett': -4887204, 'Paul Schrader': -4937934, 'Henry Selick': -4994085, 'Vipul Amrutlal Shah': -5000000, 'David Raynr': -5097885, 'Wayne Kramer': -5500000, 'Mark Duplass': -5582420, 'Jay Duplass': -5582420, 'John Landis': -5650813, 'Ron Shelton': -5762530, 'Tony Goldwyn': -5767020, 'Saul Dibb': -5895284, 'Simon Hunter': -5966835, 'Will Finn': -6048539, 'John Sanford': -6048539, 'Peter Cattaneo': -6237110, 'Daniel Sackheim': -6380391, 'Atom Egoyan': -6540542, 'Henry Alex Rubin': -6571952, 'Michael Cristofer': -6597680, 'Matthijs van Heijningen Jr.': -6871330, 'Russell Crowe': -6979977, 'Floria Sigismondi': -7004189, 'Michael Haneke': -7061128, 'John McTiernan': -7207439, 'Marcel Langenegger': -7258702, 'Dito Montiel': -7360655, 'Todd Lincoln ': -7372508, 'Bill Paxton': -7458375, 'Dewey Nicks': -7586085, 'Anthony Hemingway': -7634623, 'Justin Chadwick': -7670000, 'John Maybury': -7873775, 'Jonathan Glazer': -7919749, 'Jim Sonzero': -8092315, 'Gary McKendry': -8222894, 'Uli Edel': -8444012, 'Liam Lynch': -8594405, 'William Dear': -8621007, 'Susannah Grant': -8841513, 'Davis Guggenheim': -8891180, 'Robert Stevenhagen': -9122855, 'Craig Mazin': -9128166, 'Douglas Aarniokoski': -9156392, 'Brendan Malloy': -9217324, 'Emmett Malloy': -9217324, 'Don McKellar': -9269982, 'Robert B. Weide': -9713701, 'Niki Caro': -9775758, 'Mary Lambert': -9782502, 'Beeban Kidron': -9796980, 'Christian Duguay': -9800895, 'John Frankenheimer': -9831030, 'David MichÃ´d': -9954577, 'Christian Alvart': -10354673, 'Paul Johansson': -10372625, 'Joe Cornish': -10385849, 'Lexi Alexander': -10410627, 'Kasi Lemmons': -10481811, 'J.C. Chandor': -10884210, 'Alan Parker': -11044402, 'David Mamet': -11137288, 'Mort Nathan': -11413624, 'RyÃ»hei Kitamura': -11466773, 'Joe Dante': -11485156, 'Steven Knight': -11647115, 'Kerry Conran': -12041304, 'Michael Davis': -12179359, 'Penny Marshall': -12256692, 'John Curran': -12520282, 'Neil Marshall': -12973785, 'Brian Koppelman': -12975218, 'David Levien': -12975218, 'Susanne Bier': -13150858, 'Justin Zackham': -13180652, 'Paolo Sorrentino': -13209021, 'Alejandro Monteverde': -13579681, 'Miguel Sapochnik': -13590109, 'John Carpenter': -13989168, 'E. Elias Merhige': -14000000, 'Roland JoffÃ©': -14373200, 'Amy Heckerling': -14423505, 'Steven Shainberg': -14518911, 'Kurt Wimmer': -14640355, 'Todd Graff': -14789012, 'Bruce Hunt': -14992009, 'Michael Dowse': -15224932, 'David Barrett': -15363831, 'Gary Chapman': -15521894, 'Stephen Anderson': -15540000, 'William Friedkin': -16100923, 'Barry Levinson': -16436363, 'Mike Disa': -16478171, 'Eli Roth': -16542582, 'Werner Herzog': -17233755, 'Pitof': -17897621, 'Don Michael Paul': -18567273, 'Marco Schnabel': -20180936, 'Dan Bradley': -20193217, 'William Monahan': -20355892, 'Walter Salles': -20742589, 'Harold Becker': -20750706, 'Bruce Robinson': -21000000, 'Nick Hurran': -21079734, 'William Malone': -21097985, 'Les Mayfield': -21321087, 'Richard J. Lewis': -21545699, 'Andrew Davis': -21605835, 'Scott Walker': -21723049, 'Robert Redford': -21845901, 'Reginald Hudlin': -22369815, 'Keanu Reeves': -22945059, 'Joe Roth': -23009372, 'Guillaume Canet': -23084528, 'Bruce Beresford': -23731349, 'Carl Rinsch': -24037525, 'Robert De Niro': -25091435, 'Uwe Boll': -25333591, 'Courtney Solomon': -27312821, 'Akiva Goldsman': -29199769, 'Philip Kaufman': -31244124, 'Roger Donaldson': -32521337, 'David Leland': -32589251, 'Don Bluth': -38245366, 'Gary Goldman': -38245366, 'Renny Harlin': -38949184, 'Stephen Herek': -40008098, 'Des McAnuff': -40865180, 'Doug Lefler': -41696962, 'Jason Eisener': -41962103, 'Tony Bill': -42200000, \"Steve 'Spaz' Williams\": -42615954, 'Howard McCain': -42966317, 'Ronald F. Maxwell': -43076064, 'George Armitage': -43191450, 'Demian Lichtenstein': -43279825, 'Jaco Van Dormael': -43452791, 'Stephen T. Kay': -44187007, 'Steven Zaillian': -45549103, 'Luis Mandoki': -46383131, 'Sam Fell': -46524140, 'Antony Hoffman': -46536031, 'Charles Shyer': -46604061, 'Martin Brest': -46733791, 'Brian De Palma': -47286475, 'Jim Gillespie': -48583698, 'Michael Caton-Jones': -48936607, 'Richard Donner': -49854540, 'Dan St. Pierre': -51337973, 'Hironobu Sakaguchi': -51868170, 'Motonori Sakakibara': -51868170, 'Juan Diego Solanas': -51893525, 'Edgar Wright': -54297544, 'John Dahl': -56190660, 'Oliver Hirschbiegel': -58162215, 'Rod Lurie': -59032852, 'Simon Wells': -67278066, 'Joby Harold': -71626175, 'Jack Sholder': -75171919, 'Peter Hyams': -86956545, 'Ron Underwood': -92896027, 'James L. Brooks': -96289726, 'Walter Hill': -128283462, 'Sngmoo Lee': -413912431})\n"
     ]
    }
   ],
   "source": [
    ...
    "c = collections.Counter()\n",
    "\n",
    "for pp in data.imdb_id:\n",
    "    margin = data[data.imdb_id == pp].margin.iloc[0]\n",
    "    direct = data[data.imdb_id == pp].director.iloc[0]\n",
    "    for drct in direct.split('|'):\n",
    "         c[drct] += margin\n",
    "print(c)"
   ]
  },
  ...
  },
  {
   ...
   "source": [
    ...
    "for pp in data.imdb_id:\n",
    "    margin = data[data.imdb_id == pp].margin.iloc[0]\n",
    "    cast = data[data.imdb_id == pp].cast.iloc[0]\n",
    "    for act in cast.split('|'):\n",
    "         c[act] += margin\n",
    "print(c)"
   ]
  },
  ...
  },
  {
   ...
   "source": [
    ...
    "c = collections.Counter()\n",
    "\n",
    "for prodact in data.production_companies:\n",
    "    for prod in prodact.split('|'):\n",
    "        c[prod] += 1\n",
    "print(c.most_common(1))"
   ]
  },
  ...
  },
  {
   ...
   "source": [
    ...
    "for pp in data.imdb_id:\n",
    "    margin = data[data.imdb_id == pp].margin.iloc[0]\n",
    "    prod_c = data[data.imdb_id == pp].production_companies.iloc[0]\n",
    "    for pr in prod_c.split('|'):\n",
    "         c[pr] += margin\n",
    "print(c.most_common(1))"
   ]
  },
  ...
  },
  {
   ...
   "source": [
    ...
    "data['margin'] = data.revenue - data.budget\n",
    "\n",
    "profitable_year = data.groupby(['release_year'])['margin'].sum().sort_values(ascending=False).head(1)\n",
    "profitable_year"
   ]
  },
  {
  ...
  },
  {
   ...
   "source": [
    "data = pd.read_csv('cinema.csv')\n",
    "# выборка по студии и приыбыли\n",
    "data = data[data.production_companies.str.contains(\"Warner Bros\", na = False, regex=False)]\n",
    "data['margin'] = data.revenue - data.budget\n",
    "\n",
    "warner_bros = data.groupby(['release_year'])['margin'].sum().sort_values(ascending=False).head(1)\n",
    "warner_bros"
   ]
  },
  {
  ...
  },
  {
   ...
   "source": [
    "data = pd.read_csv('cinema.csv')\n",
    "# выборка по месяцу\n",
    "data['month'] = data.release_date.apply(lambda pp: pp.split('/')[0])\n",
    "\n",
    "month_ = data.groupby(['month'])['original_title'].count().sort_values(ascending=False).head(1)\n",
    "month_"
   ]
  },
  {
  ...
  },
  {
   ...
   "source": [
    "data = pd.read_csv('cinema.csv')\n",
    "# выборка по месяцам\n",
    "data['month'] = data.release_date.apply(lambda pp: int(pp.split('/')[0]))\n",
    "\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "data['margin'] = data.revenue - data.budget\n",
    "\n",
    "pivo = data.pivot_table(values=['margin'],index=['release_year', 'month'],aggfunc='sum',fill_value=0).sort_values(('margin'), ascending=False)\n",
    "\n",
    "data = pd.DataFrame(pivo.to_records())\n",
    "\n",
    "max_m = data.groupby('release_year').max()\n",
    "\n",
    "data.merge(max_m, on = ['release_year', 'margin'], how='inner').month_x.value_counts()"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    "data = pd.read_csv('cinema.csv')\n",
    "# выборка по подсчету символов\n",
    "data['len'] = data.original_title.apply(lambda pp: len(pp))\n",
    "\n",
    "\n",
    "import collections\n",
    "c = collections.Counter()\n",
    "\n",
    "for gg in data.imdb_id:\n",
    "    dat = data[data.imdb_id == gg]\n",
    "    prod_c = dat.production_companies.iloc[0]\n",
    "    d_len = dat.len.iloc[0]\n",
    "    for aa in prod_c.split('|'):\n",
    "        c[aa] += d_len\n",
    "\n",
    "for aa, l in c.items():\n",
    "    dat = data[data.production_companies.str.contains(aa, na = False, regex=False)]\n",
    "    count = dat.original_title.count()\n",
    "    c[aa] = l / count\n",
    "\n",
    "print(c.most_common(1))"
   ]
  ...
  },
  {
   ...
   "source": [
    "data = pd.read_csv('cinema.csv')\n",
    "\n",
    "data['len'] = data.original_title.apply(lambda pp: len(pp.split(' ')))\n",
    "\n",
    "\n",
    "import collections\n",
    "c = collections.Counter()\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "\n",
    "d = data.sort_values(['vote_average'], ascending=False).head(10)\n",
    "\n",
    "list1 = ['Inside Out', 'Gone Girl', '12 Years a Slave']\n",
    "list2 = ['BloodRayne', 'The Adventures of Rocky & Bullwinkl']\n",
    "list3 = ['The Lord of the Rings: The Return of the King']\n",
    "list4 = ['300', 'Lucky Number Slevin']\n",
    "\n",
    "for l in list1:\n",
  ...
  },
  {
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       "       director  all_f  margin_f  factor\n",
       "7  Ridley Scott     12        12     1.0"
      ]
     },
     "execution_count": 290,
     "metadata": {},
   ...
   "source": [
    ...
    "\n",
    "data['margin'] = data.revenue - data.budget\n",
    "pdata = data[data.margin > 0]\n",
    "\n",
    "import collections\n",
    "margin_f = collections.Counter()\n",
    "all_f = collections.Counter()\n",
    "\n",
    "for pp in data.director:\n",
    "    for gg in pp.split('|'):\n",
    "        all_f[gg] = data[data.director.str.contains(gg, na = False, regex=False)].imdb_id.count()\n",
    "        margin_f[gg] = pdata[pdata.director.str.contains(gg, na = False, regex=False)].imdb_id.count()\n",
    "\n",
    "margin_f = pd.DataFrame.from_dict(margin_f, orient='index').reset_index()\n",
    "all_f = pd.DataFrame.from_dict(all_f, orient='index').reset_index()\n",
    "margin_f.columns = ['director', 'margin_f']\n",
    "all_f.columns = ['director', 'all_f']\n",
    "gg = all_f.merge(margin_f, on='director')\n",
    "gg['factor'] = gg.margin_f / gg.all_f\n",
    "\n",
    "actor = ['Quentin Tarantino', 'Steven Soderbergh', 'Robert Rodriguez', 'Christopher Nolan', 'Clint Eastwood']\n",
    "gg[gg.director.isin(actor)] \n",
    "gg.sort_values(['factor', 'margin_f'], ascending=False).head(1)\n"
   ]
  },
  {
   "cell_type": "code",
